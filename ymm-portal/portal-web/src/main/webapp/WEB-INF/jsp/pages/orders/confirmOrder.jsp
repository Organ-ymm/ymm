                            ...
                            <div class="box-bd">
                                ...
                                <div class="invoice-info invoice-info-2" id="checkoutInvoiceDetail"  style="display:none;" >
                                    ...
                                    <div  id='CheckoutInvoiceTitle' class=" hide  invoice-title">
                                        ...
                                        <input id="Checkout[invoice_title]" type="text" maxlength="49" value="" class="input"> <span class="tip-msg J_tipMsg"></span>
                                    </div>
...
//                                                    checkoutConfig.totalPrice=244.00;
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/orderStatic/js/address_all.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/orderStatic/js/checkout.min.js"></script>
</div>
