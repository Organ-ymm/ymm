...
<div class="weadmin-body">
    ...
    <div class="weadmin-block">
        <button class="layui-btn" onclick="WeAdminShow('添加品牌','./brand_add')"><i class="layui-icon"></i>添加品牌</button>
...
<script type="text/html" id="operateTpl">
    ...
    <a title="删除" id="cat_del" onclick="brand_del(this)" href="javascript:;">
        <i class="layui-icon">&#xe640;</i>
    </a>
</script>
<script>
    ...
    layui.use(['table', 'jquery', 'admin'], function () {
        ...
        table.render({
            ...
            cols: [
                [{
                    field: 'brand_id', title: '品牌号',sort:true
                }, {
                    field: 'brand_name', title: '品牌名称'
                }, {
                    field: 'logo', title: '展示图片'
                },{
                    field: 'add_time', title: '加入的时间'
                },{
                    field: 'country', title: '所属时间'
                },{
        ...
        window.brand_del = function (obj) {
            layer.confirm('确认要删除吗？', function (index) {
                ...
                $.ajax({
                    ...
                    dataType: "text",
                    type: "GET",
                    url: "${pageContext.request.contextPath}/article/article_del",
